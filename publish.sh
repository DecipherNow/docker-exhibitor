...
docker push "deciphernow/exhibitor:${EX_MAJOR}-${ZK_MAJOR}" 
docker push "deciphernow/exhibitor:${EX_MAJOR}.${EX_MINOR}-${ZK_MAJOR}.${ZK_MINOR}" 
docker push "deciphernow/exhibitor:${EX_MAJOR}.${EX_MINOR}.${EX_PATCH}-${ZK_MAJOR}.${ZK_MINOR}.${ZK_PATCH}" 
